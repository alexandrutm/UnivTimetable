...
AvibilityConstraintDialog::AvibilityConstraintDialog(Context & aContext, QWidget * parent)
  : QDialog(parent)
  , mContext(aContext)
{
  setupUi(this);
...
AvibilityConstraintDialog::~AvibilityConstraintDialog()
{
}

void AvibilityConstraintDialog::ColumnClicked(int col)
{
...
void AvibilityConstraintDialog::RowClicked(int row)
{
...
void AvibilityConstraintDialog::ItemClicked(QTableWidgetItem * item)
{
