...
LessonTableModel::LessonTableModel(Context& aContext, QObject* parent): QAbstractTableModel(parent), mContext(aContext) { }


int LessonTableModel::rowCount(const QModelIndex& /*parent*/) const { return mContext.GetLessonSize(); }

int LessonTableModel::columnCount(const QModelIndex& parent) const { return 4; }
